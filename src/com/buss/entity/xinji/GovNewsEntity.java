 ...
 * @Description: 政务资讯
 * @author liliming
 * @date 2016-03-30 21:40:16
 * @version V1.0   
 *
 */
@Entity
@Table(name = "xj_gov_news", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class GovNewsEntity implements java.io.Serializable {
  /**主键*/
  private java.lang.String id;
  /**部门ID*/
  private java.lang.String govId;
  /**分类ID*/
   ...
   */
  @Column(name ="GOV_ID",nullable=true,length=50)
  public java.lang.String getGovId(){
    return this.govId;
  }
   ...
   */
  public void setGovId(java.lang.String govId){
    this.govId = govId;
  }
  /**
   *方法: 取得java.lang.String
