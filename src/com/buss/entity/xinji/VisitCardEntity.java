 ...
 */
@Entity
@Table(name = "xj_visit_card", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class VisitCardEntity implements java.io.Serializable {
  /**主键*/
   ...
   */
  @Column(name ="THUMBNAIL",nullable=true,length=500)
   ...
   *@return: java.lang.Object  详细内容，富文本内容
   */
   ...
   *@param: java.lang.Object  详细内容，富文本内容
   */
