 ...
 * @Description: 政务部门
 * @author liliming
 * @date 2016-03-30 21:39:09
 * @version V1.0   
 *
 */
@Entity
@Table(name = "xj_gov_department", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class GovDepartmentEntity implements java.io.Serializable {
  /**主键*/
  ...
  /**
   *方法: 取得java.lang.String
   *@return: java.lang.String  banner图片，多张以（|） 分隔
   */
  @Column(name ="BANNER_IMGS",nullable=true,length=2000)
  ...
  /**
   *方法: 设置java.lang.String
   *@param: java.lang.String  banner图片，多张以（|） 分隔
   */
