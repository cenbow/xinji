 ...
 */
@Entity
@Table(name = "xj_car_repair_company", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class CarRepairCompanyEntity implements java.io.Serializable {
  /**主键*/
   ...
   *@return: java.lang.Object  详细内容，富文本详细内容
   */
   ...
   *@param: java.lang.Object  详细内容，富文本详细内容
   */
