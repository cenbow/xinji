...
<body>
    ...
    <div id="login">
        ...
        <div class="inner">
            <div class="logo"><h1 style='border-bottom:none;'>智慧辛集后台管理系统</h1></div>
            <div class="formLogin">
    ...
    <div class="clear"></div>
    <div id="versionBar">
        <div class="copyright">&copy; <t:mutiLang langKey="common.copyright"/> <span class="tip"><a href="#" title=<t:mutiLang langKey="common.platform"/>>智慧辛集</a> <t:mutiLang langKey="common.browser.recommend"/>:<a href="#" title=<t:mutiLang langKey="common.platform"/>>智慧辛集</a></span></div>
    </div>
    <!-- Link JScript-->
