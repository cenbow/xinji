    ...
    <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="driverCompanyController.do?save">
      ...
      <table style="width: 1200px;" cellpadding="0" cellspacing="1" class="formtable">
        <tr>
          ...
          <td class="value">
            <input class="inputxt" id="name" name="name" ignore="ignore" value="${driverCompanyPage.name}">
        ...
        <tr>
          ...
          <td class="value">
            <input class="inputxt xj_uploader_input" id="thumbnail" name="thumbnail" value="${driverCompanyPage.thumbnail}" placeholder="点击选择文件">
        ...
        <tr>
          ...
          <td class="value">
            <input class="inputxt" id="sortOrder" name="sortOrder" ignore="ignore" value="${driverCompanyPage.sortOrder}" datatype="n">
            <span class="Validform_checktip"></span>
          </td>
        </tr>
        <tr>
          ...
          <td class="value">
            <t:dictSelect field="status" typeGroupCode="status" hasLabel="false" defaultVal="${driverCompanyPage.status}" ></t:dictSelect>
            <span class="Validform_checktip"></span>
          </td>
        </tr>
        <tr>
          ...
          <td class="value">
            <t:ckeditor name="content" isfinder="false" type="width:1000" value="${driverCompanyPage.content}"></t:ckeditor>
            <span class="Validform_checktip"></span>
          </td>
        </tr>
      </table>
