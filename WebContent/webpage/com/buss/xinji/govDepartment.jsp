...
<html>
  ...
  <body style="overflow-y: hidden" scroll="no">
    <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="govDepartmentController.do?save">
      <input id="id" name="id" type="hidden" value="${govDepartmentPage.id }">
      <table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
        <tr>
          ...
          <td class="value">
            <input class="inputxt" id="name" name="name" datatype="*" value="${govDepartmentPage.name}">
        ...
        <tr>
          ...
          <td class="value">
            <input class="inputxt xj_uploader_input" id="thumbnail" name="thumbnail" value="${govDepartmentPage.thumbnail}" placeholder="点击选择图片">
        ...
        <tr>
          ...
          <td class="value">
            <input class="inputxt xj_uploader_input" id="bannerImgs" name="bannerImgs" value="${govDepartmentPage.bannerImgs}" placeholder="点击选择图片，可选多张">
        ...
        <tr>
          ...
          <td class="value">
            <input class="inputxt" id="sortOrder" name="sortOrder" ignore="ignore" value="${govDepartmentPage.sortOrder}" datatype="n">
            <span class="Validform_checktip"></span>
          </td>
        </tr>
        <tr>
          ...
          <td class="value">
            <t:dictSelect field="status" typeGroupCode="status" hasLabel="false" defaultVal="${govDepartmentPage.status}" ></t:dictSelect>
            <span class="Validform_checktip"></span>
          </td>
        </tr>
      </table>
