        ...
        <tr>
          ...
          <td class="value">
            <c:forEach items="${categoryList}" var="category">
              <input type="checkbox" name="categoryids" value="${category.id}" <c:if test="${fn:contains(townInfoPage.categoryIds, category.id)}">checked="checked"</c:if>>${category.name}<br>
            </c:forEach>
            <span class="Validform_checktip"></span>
          </td>
        </tr>
