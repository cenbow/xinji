...
<html>
  ...
  <body style="overflow-y: scroll">
    <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="visitCardController.do?save">
      <input id="id" name="id" type="hidden" value="${visitCardPage.id }">
      <table style="width: 1200px;" cellpadding="0" cellspacing="1" class="formtable">
        <tr>
          ...
          <td class="value">
            <input class="inputxt" id="title" name="title" ignore="ignore" value="${visitCardPage.title}">
        ...
        <tr>
          ...
          <td class="value">
            <input class="inputxt xj_uploader_input" id="thumbnail" name="thumbnail" value="${visitCardPage.thumbnail}" placeholder="点击选择文件">
        ...
        <tr>
          ...
          <td class="value">
            <input class="inputxt" id="sortOrder" name="sortOrder" ignore="ignore" value="${visitCardPage.sortOrder}" datatype="n">
            <span class="Validform_checktip"></span>
          </td>
        </tr>
        <tr>
          ...
          <td class="value">
            <t:dictSelect field="status" typeGroupCode="status" hasLabel="false" defaultVal="${visitCardPage.status}" ></t:dictSelect>
            <span class="Validform_checktip"></span>
          </td>
        </tr>
        <tr>
          ...
          <td class="value">
            <t:ckeditor name="content" isfinder="false" type="width:1000" value="${visitCardPage.content}"></t:ckeditor>
            <span class="Validform_checktip"></span>
          </td>
        </tr>
      </table>
