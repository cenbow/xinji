...
<html>
  ...
  <body style="overflow-y: scroll">
    <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="businessActivityController.do?save">
      <input id="id" name="id" type="hidden" value="${businessActivityPage.id }">
      <table style="width: 1200px;" cellpadding="0" cellspacing="1" class="formtable">
        <tr>
          ...
          <td class="value">
            <input class="inputxt" id="title" name="title" ignore="ignore" value="${businessActivityPage.title}">
        ...
        <tr>
          ...
          <td class="value">
            <input class="inputxt xj_uploader_input" id="thumbnail" name="thumbnail" value="${businessActivityPage.thumbnail}" placeholder="点击选择文件">
        ...
        <tr>
          ...
          <td class="value">
            <input class="inputxt" id="sortOrder" name="sortOrder" ignore="ignore" value="${businessActivityPage.sortOrder}" datatype="n">
            <span class="Validform_checktip"></span>
          </td>
        </tr>
        <tr>
          ...
          <td class="value">
            <t:dictSelect field="status" typeGroupCode="status" hasLabel="false" defaultVal="${businessActivityPage.status}" ></t:dictSelect>
            <span class="Validform_checktip"></span>
          </td>
        </tr>
        <tr>
          ...
          <td class="value">
            <t:ckeditor name="content" isfinder="false" type="width:1000" value="${businessActivityPage.content}"></t:ckeditor>
            <span class="Validform_checktip"></span>
          </td>
        </tr>
      </table>
